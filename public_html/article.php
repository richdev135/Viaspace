...
<head>
<title> Viaspace : VIASPACE In the News </title>
<?php include_once('inc_meta.php'); ?>
 ...
 <div id="main_container" class="main_container">
				...
				<div id="body" class="body">
					...
					<h1>VIASPACE In the News</h1><hr />					
					
					<?php
		
					if($_GET['id'] !== "" && is_numeric($_GET['id']) ){
						//pull news article from id
						$strQuery = "Select * from vspc_news_articles where vspc_article_id ='".$_GET['id']."' and vspc_live = 1 order by vspc_date_release DESC ";
						...
						if(is_array($res)){
							...
							$author = $res[0]["vspc_author"];
							$publication = $res[0]["vspc_publication"];
						...
						echo "Could not find News Article.";
					}
