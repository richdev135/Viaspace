...
<?php include_once('inc_meta.php'); ?>
 ...
 <div id="main_container" class="main_container">
				...
				<div id="body" class="body">
						...
						<div id="list-menu" class="list-menu">
							<ul>								
                                ...
                                <li class="currentlink">
									<a href="giant_king_grass_compare_electrical_costs.php">> Comparing Electricity Generation Costs</a>
								</li>    
							</ul>
						</div>
					</div>
					...
					<h1>Biomass Versus Fossil Fuels, Solar and Wind</h1><hr />

					<b>Biomass is a low-carbon fuel or energy source that comes from plant material such as wood, corn, sugar cane and grasses such as Giant King Grass. Biomass can be burned to generate electricity and heat, digested to produce bio methane, and converted into liquid biofuels, biochemicals and bio plastics.</b><br /><br />  
					...
					<ul>
						...
						<li>Scalability to meet demand  for large amounts of electrical energy, bio-fuels, bio-gas, and other green-energy products</li>  
					...
					Today, biomass electricity is generated using agricultural and forestry waste such as corn stover, wheat straw, rice husks, sawdust, and wood bark. Sometimes municipal solid waste is classified as biomass. Future liquid biofuels are also targeting agricultural waste as a feedstock.<br /><br /> 

					<b>However agricultural waste has several problems:</b> 

					<ul>
						<li>It is seasonal and is not available until the food crop or cotton crop is harvested. At harvest, there is an abundance of waste, but this must be gathered, dried and stored until the next crop is harvested.</li>
						<li>In different seasons, wastes from different crops become available and there is no consistency of the fuel or feedstock.</li>  
						...
						<li>It is expensive. Although the waste originally had little value to the farmer and was often burned or plowed under, farmers in India, China and Thailand have tripled the price over the last several years.</li>
						...
						<li>Agricultural waste must be collected over a substantial radius-- say 50 km-- and this presents logistic problems.</li>
					</ul>
					 
					Forestry waste also depends on the business cycle. The amount of sawdust and wood scraps available is much lower today because of the reduced homebuilding and other construction due to the economic slowdown.<br /><br />       

					Because of these issues, many biomass power plants in India for example are running at partial capacity because biomass is not available or closed down because the fuel is too expensive to operate profitably.<br /><br />   
					
					<div class="figure" style="margin-bottom:20px;">
						  <img src="images/gkg13ft.png" alt="Giant King Grass Plantation (13 Feet Tall)">
						  <p>Giant King Grass Plantation (13 Feet Tall)</p>
					</div>

					The biomass industry has recognized that dedicated energy crops are going to be required as the primary source of fuel or feedstock for their plants in addition to agricultural and forestry waste. These dedicated energy crops can be perennial grasses such as Giant King Grass, fast-growing, short rotation trees similar to those being used in the pulp and paper industry, Jatropha and other plants.<br /><br />

					Among the different types of dedicated energy crops, non-food perennial grasses are practical and effective for producing green energy. Giant King Grass can be grown in areas considered marginal or unsuitable for food crops. Therefore, cultivation of non-food grasses does not compete with food or food-related crops such as corn; nor does it interfere or compete with valuable natural resources such as forests and other timberland. The use of food crops for bio-fuels is being discouraged or banned in almost all countries worldwide.<br /><br />
