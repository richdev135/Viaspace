...
<head>
<title> Viaspace : Biomass Versus Fossil Fuels, Solar and Wind </title>
<?php include_once('inc_meta.php'); ?>
 ...
 <div id="main_container" class="main_container">
				...
				<div id="body" class="body">
					<div id="lmenu" class="lmenu">
						<div id="list-menu" class="list-menu">
							<ul>								
								...
								<li class="currentlink">> Biomass Versus Alternatives</li>	
                                <li><a href="giant_king_grass_compare_electrical_costs.php">> Comparing Electricity Generation Costs</a>
								</li>    
							</ul>
						</div>
					</div>
					...
					<h1>Biomass Compared to Fossil Fuels, Solar and Wind</h1>
					<hr />
					...
					<br/>
					Note that fossil fuel plants in industrialized countries are huge, producing 500 MW of electricity or more. A large biomass plant is 35 MW. A biogas plant could be 1 MW.  In industrialized countries, biomass can be a small, but important niche player. In a developing country or in a remote location a power plant of 1 to 35 MW may be all that is needed and biomass can play a much more important role. In the UK, several coal-fired power plants are being converted to wood pellets and these are large-size.
					<br/><br/>

					<h2>Biomass Compared to Solar and Wind</h2>
					<br/>

					Solar and wind are two largest sources of renewable electricity. 
					<br/><br/>

					The major advantage of both solar and wind is that the source of energy is free. Furthermore operations and maintenance costs are modest, and the cost of the capital investment has come down dramatically. The total cost of solar and wind electricity is mostly paying off the capital investment.
					<br/><br/>

					The major disadvantages of solar and wind are that they are variable and intermittent sources of energy. The amount of electricity produced varies by the season and fluctuates minute to minute. Some of the variability is removed by combining the output of many solar and wind farms located in different areas. Even with combining the output of more than 5000 wind turbines, the figure below shows that wind is still extremely variable.
					<br/><br/>
					<div class="figure" style="margin-bottom:20px;">
						  <img src="images/biomass/windoutput.jpg" width="600px" alt="Combined output of all the 5000+ wind turbines feeding the grid in the UK March 2014.">
						  <p>Combined output of all the 5000+ wind turbines feeding the grid in the UK March 2014.</p>
					</div>

					In addition to the hourly fluctuations, this figure shows that the average output of all the wind farms in the UK was 32.4% of the rated capacity. A wind turbine that can produce 5 MW when the wind is blowing at maximum speed, only produces on average 1.62 MW because the wind doesn’t blow at maximum speed very often.
					<br/><br/>

					Solar energy depends on the amount of sunlight.  The rising and setting of the sun is predictable, but clouds can dramatically affect the output of a solar farm. The figure below showing electrical output from a small fixed array solar facility in sunny Arizona illustrates the problem.
					<br/><br/>
					<div class="figure" style="margin-bottom:20px;">
						  <img src="images/biomass/solaroutput.jpg" width="600px" alt="Output of solar facility in Arizona over seven days.">
						  <p>Output of solar facility in Arizona over seven days.</p>
					</div>
					<br/>
					The third day is an almost cloudless day and shows the optimum output from a fixed solar array. There is no solar output after sundown and the curves show small electrical production at sunrise, going to a maximum at noon and then falling again until sunset. This is predictable day-to-day, but the presence of clouds can change the output hour by hour.  The effect of clouds can be reduced somewhat by combining the output of many solar farms, but is not eliminated. Furthermore the amount of sunlight is seasonal-- lowest in winter and highest in summer.
					<br/><br/>

					<div class="figure" style="margin-bottom:20px;">
						  <img src="images/biomass/solarfarms.jpg" width="600px" alt="Combined output of many solar farms showing daily and seasonal variations.">
						  <p>Combined output of many solar farms showing daily and seasonal variations.</p>
					</div>
					<br/>
					The figures above clearly show the inherent problems with the variability, intermittency and seasonality of wind and solar electricity. 
					<br/><br/>
					...
					<div class="figure" style="margin-bottom:20px;">
						  ...
						  <p>Example scenario of large amount of natural gas generation needed to be added to base electricity (shown as nuclear in this case), wind and other renewables to smooth out fluctuations and  meet the daily demand.</p>
					</div>
					<br/>
					The figure above illustrates the issues with managing the grid to meet demand. Demand varies minute to minute and by time of day. Usually demand is higher in the daytime and early evening, and lower at night, and higher during the workweek and lower during the weekend. Grid operators need to have a combination of steady base power that is always on and resources that can be turned on for a portion of the day, and fast reacting power to provide the minute by minute demand.
					<br/><br/>

					Before solar and wind, grid operators only had to deal with variable demand.  With wind and solar, the sources are variable as well as demand. This makes the control issues more complicated, but are still manageable.  Since the grid already had some fast reacting capability to handle variations in demand, inserting small amounts of variable solar and wind into the grid could be handled without adding new backup capability or affecting the grid substantially.  Large amounts of fluctuating solar and wind electricity present challenges to grid operators and require investment in new backup systems and updating the grid.
					<br/><br/>
					...
					<h2>Biomass Alternatives: Dedicated Energy Crops Compared to Wood and Agricultural Waste</h2>

					<b>The primary requirements that a biomass crop must satisfy to be considered a viable source of green energy are:</b>
					<ul>
						<li>No conflict with food-crop acreage or food-supply chain</li>
						<li>Scalability to meet demand for large amounts of electrical energy, biofuels, biogas, and other green energy products</li>
						<li>Continuity of supply with consistent quality</li>
					...
					<ul>
						...
						<li>In different seasons, wastes from different crops become available and there is no consistency of the fuel or feedstock.
						
						<li>Reliability of supply is uncertain. A farmer may decide from year-to-year what to grow and the waste from the new crop may not be suitable for the biomass application.</li>
					...
					<div class="figure" style="margin-bottom:20px;">
						<table>
							<tr>
								<td>
									<img src="images/biomass/14footgrass.jpg" width="244px" alt="14 foot high Giant King Grass">
									<p>Giant King Grass (14 Feet Tall)</p>
								</td>
								<td>
									<img src="images/biomass/aeralview.jpg" width="356px" alt="Aerial view.">
									<p>Aerial view of Giant King Grass test plots</p>
								</td>
							</tr>
						  </table>
					</div>
