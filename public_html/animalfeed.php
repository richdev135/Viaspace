...
<head>
<title> Viaspace : Animal Feed </title>
 ...
 <div id="main_container" class="main_container">
				...
				<div id="body" class="body">
					<div id="lmenu" class="lmenu">
						<div id="list-menu" class="list-menu">
							<ul>								
								...
								<li class="header">Animal Feed</li>
								<li class="currentlink">> Animal Feed</li>								
							</ul>
						</div>
					</div>
					...
					<table width="440px">
						<tr>
							<td style="width:220px">
								<img src="images/animalfeed/youngkinggrass1.jpg" width="220px"  />
							</td>
							<td style="width:220px">
								<img src="images/animalfeed/youngkinggrass2.jpg" width="220px" />
							</td>
						</tr>
					</table>
                    <p>Young Giant King Grass can be fed directly to animals without chopping.</p>
                    </div>
					...
					<table width="600px">
						<tr>
							<td style="width:200px">
								<img src="images/animalfeed/40dayold1.jpg" width="155px"  />
							</td>
							<td style="width:200px">
								<img src="images/animalfeed/40dayold2.jpg" width="155px" />
							</td>
							<td style="width:200px">
								<img src="images/animalfeed/40dayold3.jpg" width="280px" />
							</td>
						</tr>
					</table>
                    <p>40-45 day old Giant King Grass can be harvested, field dried and baled into hay.</p>
                    </div>
					...
					<table width="550px">
						<tr>
							<td>
								<img src="images/animalfeed/60dayold1.jpg" width="175px"  />
							</td>
							<td>
								<img src="images/animalfeed/60dayold2.jpg" width="350px" />
							</td>
						</tr>
					</table>
                    <p>60 day old Giant King Grass has highest yield with good nutrition, and can be chopped for fresh green chop or made into silage.</p>
                    </div>
                    <br/><br/>
                    <div class="figure blockdiv">
					<table width="595px">
						<tr>
							<td>
								<img src="images/animalfeed/silage.jpg" width="394px"  />
							</td>
							<td>
								<img src="images/animalfeed/silage2.jpg" width="205px" />
							</td>
						</tr>
					</table>
                    <p>Silage pile at left and silage bag at right stores fresh and nutritious Giant King Grass for up to three years</p>
                    </div>
                    <br/><br/>
                    <br/><br/>
                    <br/><br/>
