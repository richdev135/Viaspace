...
<?php include_once('inc_meta.php'); ?>
 ...
 <div id="main_container" class="main_container">
				...
				<div id="body" class="body">
					<div id="lmenu" class="lmenu">
						<div id="list-menu" class="list-menu">
							<ul>								
                                ...
                                <li class="currentlink">> Comparing Electricity Generation Costs</li>    
                            </ul>
						</div>
					</div>
					<div id="body_content" class="body_content">
					
					<h1>Giant King<sup class="big">&reg</sup> Grass Electricity Cost Compared to Fossil Fuels and Other Renewables</h1>
					<hr />
					<b>
					...
					Basic assumptions
					<ul style="margin:2px">
						<li>Calculations are for a new power plant built in 2017. Electricity generation costs using an existing and paid for power plant will be much lower.</li>
						<li>The costs of the Giant King Grass powerplants are from actual quotations.</li>
						<li>The Giant King Grass powerplants and coal power plants meet World Bank emissions standards. Costs in the US or Western Europe will be significantly higher because of more stringent emissions standards, and other factors.</li>
						<li>The costs of other technology power plants are from the EIA and the current literature. As an example, the price of solar plants has gone down significantly in the last year which is not reflected in the EIA report which was completed in early 2016.</li>
						<li>The price of fossil fuels is current as of April 2017.</li>
						<li>The fixed and variable operations costs per megawatt hour are from the EIA.</li>
						<li>A cost per megawatt hour for installing the transmission line to connect to the grid is included. This cost is from the EIA.</li>
					</ul>
					<br/>
					The numbers below are costs not electricity sales prices. A simple 8% interest is assumed to pay back the capital equipment over 10 years. A business will have to sell the electricity at a higher price to pay business taxes and to make a profit.
					<br/><br/>
					<b>Electricity Costs</b>
					<br/><br/>
					...
					<div class="figure" style="margin-bottom:20px;">
					  <img src="images/compareelectrical/costsfromfuel.jpg" width="600px" alt="This chart shows the portion of the final electricity cost that comes from the fuel used in the power plant.">
					...
					<br/><br/>
					To put this in terms of electricity costs, you divide the total of the principal plus interest payments over 10 years by the amount of electricity produced over the same period of time. Coal, oil, natural gas and biomass and biogas power plants are all mature technologies and will operate at least 90% of the year which is 7884 hours. According to EIA, hydroelectricity is seasonal and only available 58% of the time. We use EIA's assumption that wind is available 40% of the time (which is generous) and solar 25%. This reduced availability means that the denominator in the equation CAPEX/megawatt hours is lower because 1 MW of solar only yields on average 0.25 MWh of electricity each hour. When a solar or wind facility is announced, they announce the peak power, but the average achievable power is only 25% or 40% of that respectively. All of these power plants will last 20 to 30 years, but the bank financing will be 10 years or a bit longer.
					<br/><br/>
					<div class="figure" style="margin-bottom:20px;">
					  <img src="images/compareelectrical/costcapex.jpg" width="600px" alt="Simple Estimate of Portion of Electricity Cost from CAPEX">
					  <p></p>
					</div>

					The first important point to note is how relatively inexpensive the reciprocating engine generator power plants are for diesel, heavy fuel oil and natural gas. These are extremely mature and reliable internal combustion engines. 
					<br/><br/>
					...
					<b>Overall electricity costs</b> are compared in the summary figure below. The electricity costs are in dollars per megawatt hour (which is 1000 times the price per kilowatt hour). Also shown are the carbon dioxide emissions per megawatt hour of electricity generated.
					<br/><br/>
					<div class="figure" style="margin-bottom:20px;">
					  <img src="images/compareelectrical/costofnewelectricity.jpg" width="600px" alt="Estimated Cost of New Electricity and Carbon Dioxide Emissions">
