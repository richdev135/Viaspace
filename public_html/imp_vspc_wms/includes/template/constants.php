...
//build table objects for nav links and form construction 	
		...
		/*
			//Press Releases
			$table_name = "vspc_mail_list";
			//nav link
				$MyObjects[$table_name]["caption"] = "Mail List";
			//primary feild
				$MyObjects[$table_name]["primary_field"] = "vspc_mail_id";
			...
			//feilds input type
				...
				$MyObjects[$table_name]["fields"][$field]					["input_name"]		= $field;
				$MyObjects[$table_name]["fields"][$field]					["input_value"]		= "";
				$MyObjects[$table_name]["fields"][$field]					["caption"]			= "Email";
				$MyObjects[$table_name]["fields"][$field]					["display"]			= true;
				$MyObjects[$table_name]["fields"][$field]					["form_display"]	= true;
				...
				$MyObjects[$table_name]["fields"][$field]					["input_name"]		= $field;
				$MyObjects[$table_name]["fields"][$field]					["input_value"]		= "";
				$MyObjects[$table_name]["fields"][$field]					["caption"]			= "Date Added";
				$MyObjects[$table_name]["fields"][$field]					["display"]			= true;
				$MyObjects[$table_name]["fields"][$field]					["form_display"]	= true;
				...
				$MyObjects[$table_name]["fields"][$field]					["input_name"]		= $field;
				$MyObjects[$table_name]["fields"][$field]					["input_value"]		= "";
				$MyObjects[$table_name]["fields"][$field]					["caption"]			= "Active";
				$MyObjects[$table_name]["fields"][$field]					["display"]			= true;
				$MyObjects[$table_name]["fields"][$field]					["form_display"]	= true;
