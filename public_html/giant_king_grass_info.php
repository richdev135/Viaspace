...
<?php include_once('inc_meta.php'); ?>
 ...
 <div id="main_container" class="main_container">
				...
				<div id="body" class="body">
					...
					pellets for cofiring with coal, the main objective is to maximize total energy content and this
					means maximizing biomass yield per acre. This is achieved by letting the Giant King Grass
					grow tall with woody stalks. Harvesting is at approximately 6 months. Testing has shown that
					the maximum ethanol production is achieved at six months old. In a tropical area, there can be two harvests per year.
					<div class="figure">
					  <img src="images/kinggrassinfo/kinggrass6months.1.jpg" alt="Giant King Grass at six months is typically 14-17 feet (4.3-5.2m) tall" style="width:440px;height:225px" />
					  <img src="images/kinggrassinfo/kinggrass6months.2.jpg" alt="Giant King Grass at six months is typically 14-17 feet (4.3-5.2m) tall" style="width:150px;height:225px"/>
					  <p>Giant King Grass at six months is typically 14-17 feet (4.3-5.2m) tall</p>
					</div>
					...
					<div class="figure" style="margin-bottom:20px;">
					  <img src="images/kinggrassinfo/kinggrass6months70-90.1.jpg" 
					  alt="Giant King Grass at 70-90 days" style="width:290px">
					  <img src="images/kinggrassinfo/kinggrass6months70-90.2.jpg" 
					  alt="Giant King Grass at 70-90 days" width="290px">
					  <p>Giant King Grass at 70 and 90 days old. Both are suitable for anaerobic digestion.</p>
					</div>
					<br/>
					For animal feed, the primary considerations are high nutritional value including protein and
					...
					<div class="figure" style="margin-bottom:20px;">
					  <img src="images/kinggrassinfo/kinggrass6months40-60.1.jpg" 
					  alt="Giant King Grass at 40-60 days" style="width:290px">
					  <img src="images/kinggrassinfo/kinggrass6months40-60.2.jpg" 
					...
					VIASPACE will train the customer in all aspects of Giant King Grass agriculture.
					The yield of Giant King Grass depends on the time between harvests. For example, a six-month
					harvest of tall Giant King Grass, one can expect to obtain 80 or more US tons per acre (180
					metric tons per hectare) of fresh grass at approximately 70-75% moisture. For two harvests per
					year, double these figures. Giant King Grass regrows after cutting for seven years or more.
					<br/><br/>
